...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        odoo_tittle_name = ir_config.get_param('odoo_tittle_name', default='Dreamwarez')
        odoo_website_url = ir_config.get_param('odoo_website_url', default='http://www.dreamwarez.in')
